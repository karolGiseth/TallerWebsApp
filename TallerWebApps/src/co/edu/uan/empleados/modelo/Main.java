...
public class Main {
	...
	public static void main(String[] args) {		
		...
		// Begin transaction, if you would like save your instances, your calling of
		// save must be associated with a transaction
		session.getTransaction().begin();
		// Create employee
		Empleado emp = new Empleado();
		emp.setNombre("Andrés Pérez");
		emp.setSalario(2000L);
